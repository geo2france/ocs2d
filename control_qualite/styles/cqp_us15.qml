...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" maxScale="0" minScale="100000000" simplifyMaxScale="1" version="3.28.10-Firenze" simplifyLocal="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0">
  ...
  <fieldConfiguration>
    ...
    <field name="us15" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
    ...
    <field name="doute15" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="1" field="us15"/>
    <alias name="" index="2" field="doute15"/>
    <alias name="source" index="3" field="source15"/>
    <alias name="comment_producteur" index="4" field="comment15"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="us15"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="doute15"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="source15"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="comment15"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="us15"/>
    <constraint exp="" desc="" field="doute15"/>
    <constraint exp="" desc="" field="source15"/>
    <constraint exp="" desc="" field="comment15"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="us15" width="-1" type="field"/>
      <column hidden="0" name="doute15" width="-1" type="field"/>
      <column hidden="0" name="source15" width="-1" type="field"/>
      <column hidden="0" name="comment15" width="-1" type="field"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="Zones Tests" collapsed="0" showLabel="1" collapsedExpressionEnabled="0" collapsedExpression="" columnCount="1" visibilityExpressionEnabled="0" groupBox="0">
      ...
      <attributeEditorContainer visibilityExpression="" name="Info Polygone" collapsed="0" showLabel="1" collapsedExpressionEnabled="0" collapsedExpression="" columnCount="1" visibilityExpressionEnabled="0" groupBox="1">
        ...
        <attributeEditorField name="source15" showLabel="1" index="3">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont strikethrough="0" description="Fira Sans Semi-Light,10,-1,5,50,0,0,0,0,0" style="" underline="0" bold="0" italic="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="comment15" showLabel="1" index="4">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont strikethrough="0" description="Fira Sans Semi-Light,10,-1,5,50,0,0,0,0,0" style="" underline="0" bold="0" italic="0"/>
          </labelStyle>
        </attributeEditorField>
