...
<qgis labelsEnabled="1" readOnly="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" version="3.24.3-Tisler" styleCategories="AllStyleCategories" minScale="100000000" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyMaxScale="1" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias index="1" name="" field="us21"/>
    <alias index="2" name="" field="indice21"/>
    <alias index="3" name="source" field="source21"/>
    <alias index="4" name="comment_producteur" field="comment21"/>
    <alias index="5" name="" field="photovol21"/>
    <alias index="6" name="surface_m2" field="area"/>
    <alias index="7" name="" field="id"/>
    <alias index="8" name="nom_zone" field="Nom"/>
    <alias index="9" name="etat_cqp" field="etat_cqp"/>
    <alias index="10" name="code_remplacement" field="code_remplac"/>
    <alias index="11" name="erreur_geometrique" field="erreur_geom"/>
    <alias index="12" name="commentaire_cqp" field="com_cqp"/>
    <alias index="13" name="valide_cqe" field="etat_cqe"/>
    <alias index="14" name="libelle" field="LIBELLE_NOACCENT"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="1" field="etat_cqp" expression=" 'noverif' "/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="us21"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="indice21"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="source21"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="comment21"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="photovol21"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="indice21" desc=""/>
    ...
    <constraint exp=" &quot;etat_cqp&quot; = 'erreur' " field="code_remplac" desc="Le champ état doit être en erreur pour proposer un nouveau code"/>
    <constraint exp=" &quot;etat_cqp&quot; = 'erreur' " field="erreur_geom" desc="Le champ état doit être en erreur pour cocher cette case"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="indice21" hidden="0" width="-1" type="field"/>
      <column name="source21" hidden="0" width="-1" type="field"/>
      <column name="comment21" hidden="0" width="-1" type="field"/>
      ...
      <column name="us21" hidden="0" width="-1" type="field"/>
      <column name="photovol21" hidden="0" width="-1" type="field"/>
