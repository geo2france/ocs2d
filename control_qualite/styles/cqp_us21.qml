...
<qgis maxScale="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" readOnly="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.22.11-Białowieża" simplifyMaxScale="1" labelsEnabled="1" minScale="100000000">
  ...
  <aliases>
    ...
    <alias name="" index="5" field="photovol21"/>
    <alias name="surface_m2" index="6" field="area"/>
    <alias name="" index="7" field="id"/>
    <alias name="" index="8" field="z"/>
    <alias name="etat_cqp" index="9" field="etat_cqp"/>
    <alias name="code_remplacement" index="10" field="code_remplac"/>
    <alias name="erreur_geometrique" index="11" field="erreur_geom"/>
    <alias name="commentaire_cqp" index="12" field="com_cqp"/>
    <alias name="Données exogènes" index="13" field="data_exo"/>
    <alias name="" index="14" field="valid_cqe"/>
    <alias name="" index="15" field="com_cqe"/>
    <alias name="code &amp; libelle" index="16" field="LIBELLE_NOACCENT"/>
  </aliases>
  <defaults>
    <default field="fid" applyOnUpdate="0" expression=""/>
    <default field="us21" applyOnUpdate="0" expression=""/>
    <default field="doute21" applyOnUpdate="0" expression=""/>
    <default field="source21" applyOnUpdate="0" expression=""/>
    <default field="comment21" applyOnUpdate="0" expression=""/>
    <default field="photovol21" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="us21"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="doute21"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="source21"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="comment21"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="photovol21"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="us21"/>
    <constraint desc="" exp="" field="doute21"/>
    <constraint desc="" exp="" field="source21"/>
    <constraint desc="" exp="" field="comment21"/>
    <constraint desc="" exp="" field="photovol21"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="source21" width="-1" type="field" hidden="0"/>
      <column name="comment21" width="-1" type="field" hidden="0"/>
      ...
      <column name="doute21" width="-1" type="field" hidden="0"/>
      <column name="photovol21" width="-1" type="field" hidden="0"/>
      ...
      <column name="us21" width="-1" type="field" hidden="0"/>
  ...
  <attributeEditorForm>
    <attributeEditorContainer name="Zones Tests" groupBox="0" visibilityExpression="" columnCount="1" visibilityExpressionEnabled="0" showLabel="1">
      <attributeEditorContainer name="Info Polygone" groupBox="1" visibilityExpression="" columnCount="1" visibilityExpressionEnabled="0" showLabel="1">
        <attributeEditorField name="LIBELLE_NOACCENT" index="16" showLabel="1"/>
      ...
      <attributeEditorContainer name="Controle Qualite" groupBox="1" visibilityExpression="" columnCount="1" visibilityExpressionEnabled="0" showLabel="1">
        <attributeEditorField name="etat_cqp" index="9" showLabel="1"/>
        <attributeEditorField name="code_remplac" index="10" showLabel="1"/>
        <attributeEditorField name="erreur_geom" index="11" showLabel="1"/>
        <attributeEditorField name="com_cqp" index="12" showLabel="1"/>
        <attributeEditorField name="data_exo" index="13" showLabel="1"/>
      </attributeEditorContainer>
      <attributeEditorContainer name="Validation CQE" groupBox="1" visibilityExpression="" columnCount="2" visibilityExpressionEnabled="0" showLabel="1">
        <attributeEditorField name="valid_cqe" index="14" showLabel="1"/>
        <attributeEditorField name="com_cqe" index="15" showLabel="1"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
