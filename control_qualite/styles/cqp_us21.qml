...
<qgis readOnly="0" version="3.22.11-Białowieża" minScale="100000000" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="2" field="doute21" name=""/>
    ...
    <alias index="13" field="data_exo" name="Données exogènes"/>
    <alias index="14" field="valid_cqe" name=""/>
    <alias index="15" field="com_cqe" name=""/>
    <alias index="16" field="LIBELLE_NOACCENT" name="code &amp; libelle"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="fid"/>
    <default applyOnUpdate="0" expression="" field="us21"/>
    <default applyOnUpdate="0" expression="" field="doute21"/>
    <default applyOnUpdate="0" expression="" field="source21"/>
    <default applyOnUpdate="0" expression="" field="comment21"/>
    <default applyOnUpdate="0" expression="" field="photovol21"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="us21"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="doute21"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="source21"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="comment21"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="photovol21"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="source21"/>
      <column type="field" hidden="0" width="-1" name="comment21"/>
      ...
      <column type="field" hidden="0" width="-1" name="doute21"/>
      <column type="field" hidden="0" width="-1" name="photovol21"/>
      ...
      <column type="field" hidden="0" width="-1" name="us21"/>
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="0" visibilityExpression="" columnCount="1" showLabel="1" visibilityExpressionEnabled="0" name="Zones Tests">
      <attributeEditorContainer groupBox="1" visibilityExpression="" columnCount="1" showLabel="1" visibilityExpressionEnabled="0" name="Info Polygone">
        <attributeEditorField index="16" showLabel="1" name="LIBELLE_NOACCENT"/>
      ...
      <attributeEditorContainer groupBox="1" visibilityExpression="" columnCount="1" showLabel="1" visibilityExpressionEnabled="0" name="Controle Qualite">
        ...
        <attributeEditorField index="13" showLabel="1" name="data_exo"/>
      </attributeEditorContainer>
      <attributeEditorContainer groupBox="1" visibilityExpression="" columnCount="2" showLabel="1" visibilityExpressionEnabled="0" name="Validation CQE">
        <attributeEditorField index="14" showLabel="1" name="valid_cqe"/>
        <attributeEditorField index="15" showLabel="1" name="com_cqe"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
