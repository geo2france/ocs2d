...
<qgis version="3.24.3-Tisler" simplifyDrawingHints="1" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="100000000" labelsEnabled="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="indice21">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias index="5" field="photovol21" name=""/>
    <alias index="6" field="area" name="surface_m2"/>
    <alias index="7" field="id" name=""/>
    <alias index="8" field="Nom" name="nom_zone"/>
    <alias index="9" field="etat_cqp" name="etat_cqp"/>
    <alias index="10" field="code_remplac" name="code_remplacement"/>
    <alias index="11" field="erreur_geom" name="erreur_geometrique"/>
    <alias index="12" field="com_cqp" name="commentaire_cqp"/>
    <alias index="13" field="etat_cqe" name="valide_cqe"/>
    <alias index="14" field="LIBELLE_NOACCENT" name="libelle"/>
  </aliases>
  <defaults>
    <default expression="" applyOnUpdate="0" field="fid"/>
    <default expression="" applyOnUpdate="0" field="us21"/>
    <default expression="" applyOnUpdate="0" field="indice21"/>
    <default expression="" applyOnUpdate="0" field="source21"/>
    <default expression="" applyOnUpdate="0" field="comment21"/>
    <default expression="" applyOnUpdate="0" field="photovol21"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="us21" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="indice21" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="source21" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="comment21" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="photovol21" exp_strength="0" constraints="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" type="field" name="indice21" width="-1"/>
      <column hidden="0" type="field" name="source21" width="-1"/>
      <column hidden="0" type="field" name="comment21" width="-1"/>
      ...
      <column hidden="0" type="field" name="us21" width="-1"/>
      <column hidden="0" type="field" name="photovol21" width="-1"/>
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" groupBox="0" visibilityExpression="" name="Zones Tests" visibilityExpressionEnabled="0" columnCount="2">
      <attributeEditorContainer showLabel="1" groupBox="1" visibilityExpression="" name="Info Polygone" visibilityExpressionEnabled="0" columnCount="1">
        <attributeEditorField index="1" showLabel="1" name="us21"/>
        <attributeEditorField index="14" showLabel="1" name="LIBELLE_NOACCENT"/>
        <attributeEditorField index="3" showLabel="1" name="source21"/>
        <attributeEditorField index="4" showLabel="1" name="comment21"/>
        <attributeEditorField index="6" showLabel="1" name="area"/>
      ...
      <attributeEditorContainer showLabel="1" groupBox="1" visibilityExpression="" name="Controle Qualite" visibilityExpressionEnabled="0" columnCount="1">
        <attributeEditorField index="8" showLabel="1" name="Nom"/>
        <attributeEditorField index="9" showLabel="1" name="etat_cqp"/>
        <attributeEditorField index="10" showLabel="1" name="code_remplac"/>
        <attributeEditorField index="11" showLabel="1" name="erreur_geom"/>
        <attributeEditorField index="12" showLabel="1" name="com_cqp"/>
        <attributeEditorField index="13" showLabel="1" name="etat_cqe"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
